    ...
    return (React.createElement("style", { dangerouslySetInnerHTML: {
            __html: Object.entries(THEMES)
                ...
                return "\n".concat(prefix, " [data-chart=").concat(id, "] {\n").concat(colorConfig
                    ...
                    var color = ((_b = itemConfig.theme) === null || _b === void 0 ? void 0 : _b[theme]) || itemConfig.color;
...
function getPayloadConfigFromPayload(config, payload, key) {
    ...
    var payloadPayload = "payload" in payload && typeof payload.payload === "object" && payload.payload !== null
        ? payload.payload
        : undefined;
