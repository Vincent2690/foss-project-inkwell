...
var InputOTPSlot = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref, className: (0, utils_1.cn)("relative flex h-10 w-10 items-center justify-center border-y border-r border-input text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md", isActive && "z-10 ring-2 ring-ring ring-offset-background", className) }, props),
        char,
        hasFakeCaret && (React.createElement("div", { className: "pointer-events-none absolute inset-0 flex items-center justify-center" },
            React.createElement("div", { className: "animate-caret-blink h-4 w-px bg-foreground duration-1000" })))));
});
