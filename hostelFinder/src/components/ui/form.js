...
var FormControl = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(react_slot_1.Slot, __assign({ ref: ref, id: formItemId, "aria-describedby": !error ? "".concat(formDescriptionId) : "".concat(formDescriptionId, " ").concat(formMessageId), "aria-invalid": !!error }, props)));
});
...
var FormDescription = React.forwardRef(function (_a, ref) {
    ...
    return React.createElement("p", __assign({ ref: ref, id: formDescriptionId, className: (0, utils_1.cn)("text-sm text-muted-foreground", className) }, props));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("p", __assign({ ref: ref, id: formMessageId, className: (0, utils_1.cn)("text-sm font-medium text-destructive", className) }, props), body));
});
