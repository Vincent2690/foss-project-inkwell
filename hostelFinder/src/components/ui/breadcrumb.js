...
var BreadcrumbSeparator = function (_a) {
    ...
    return (React.createElement("li", __assign({ role: "presentation", "aria-hidden": "true", className: (0, utils_1.cn)("[&>svg]:size-3.5", className) }, props), children !== null && children !== void 0 ? children : React.createElement(lucide_react_1.ChevronRight, null)));
};
